...
print('Print out the elements of the "goodbye" list.')
for list_tag in goodbye_list:
	print(list_tag.string)
print('------')

print('Print out the width of the img element.')
print(img_tag['width'])
print('------')

a_tag = soup.find('a')
print('Print out the URL that the <a> tag points to.')
print(a_tag['href'])
